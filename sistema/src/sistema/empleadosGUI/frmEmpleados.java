...
public class frmEmpleados extends javax.swing.JFrame {
    ...
    public frmEmpleados() {
        ...
        String[] titulos= {"ID","Nombre","Correo","Sexo"};
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        String strSentenciaInsert= String.format("INSERT INTO Empleados (ID, Nombre, Correo, Sexo)"
                + "VALUES (null, '%s','%s','%s')", oEmpleados.getNombre(), oEmpleados.getCorreo(), oEmpleados.getSexo());
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        String strSentenciaEdit= String.format("UPDATE Empleados SET Nombre='%s',"
                + "Correo='%s',Sexo='%s' WHERE ID = %d", oEmpleados.getNombre(), oEmpleados.getCorreo(), oEmpleados.getSexo(),oEmpleados.getID());
    ...
    public void mostrarDatos(){
        ...
        try {
            ...
            while (resultado.next()) {
                ...
                Object[] oUsuario={resultado.getString("ID"),resultado.getString("Nombre"),resultado.getString("Correo"), resultado.getString("Sexo")};
